...
<main class="h-full overflow-y-auto">
    <div class="container px-6 mx-auto grid">
                ...
                <table class="w-full whitespace-no-wrap border table-auto">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        ...
                        <tr class="group data-row text-center text-gray-700 dark:text-gray-400 ease-in-out duration-150" onclick="changeColor(this)">
                            ...
                            @if($key != "status")
                            @if($key != "gambar")
                            @if($key != "status_website") @if($key != "width")
        ...
        <div class="bg-white p-5 rounded-md">
            <button class="inline-flex items-center justify-between w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" @click="toggleDetailPlant" aria-haspopup="true">
